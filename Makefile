...
setup-local-nodejs-env:
	cp ./src/config/.env.example ./src/config/.env.development
	sed -i.bak 's/DATABASE_HOST=.*/DATABASE_HOST="localhost"/g' ./src/config/.env.development

setup-local-nodejs-env-test:
	cp ./src/config/.env.example ./src/config/.env.test
	sed -i.bak 's/DATABASE_HOST=.*/DATABASE_HOST="localhost"/g' ./src/config/.env.test
